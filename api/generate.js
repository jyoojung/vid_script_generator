...
5. script_snippet (숏폼 내용 요약): 단순히 원본 대사를 그대로 잘라오지 말 것. 해당 구간에서 화자가 말하고자 하는 핵심 기획 의도와 스토리를 편집자가 완벽히 이해할 수 있도록, 원본 맥락을 바탕으로 2~3문장의 '완성된 줄글(요약본)'로 다듬어서 작성할 것. 말하다 끊긴 느낌이 없도록 반드시 온점(.)으로 끝나는 완결된 문장으로만 구성하며, 읽기 편하게 문장 단위로 줄바꿈을 적용할 것.
